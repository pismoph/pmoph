        ...
        ,onTriggerClick: function(){
                ...
                switch(data_queryGrid.nowRecordEdit.data.field){
                            ...
                            case "endyear":
                                     ...
                                     break;
                            case "qcode":
                                     QueryQualify(data_queryGrid.nowRecordEdit);
                                     break;
                            case "ecode":
                                     QueryEduLevel(data_queryGrid.nowRecordEdit);
                                     break;
                            case "macode":
                                     QueryMajor(data_queryGrid.nowRecordEdit);
                                     break;
                            case "institute":
                                     SetValueQueryGrid(data_queryGrid.nowRecordEdit);
                                     break;
                            case "cocode":
                                     QueryCountry(data_queryGrid.nowRecordEdit);
                                     break;
...
var data_field_query_trigger  = [
        ...
        ,["mrcode","รหัสสถานะภาพสมรส"]
        ,["sex","เพศ"]
        ,["enddate","วันที่จบการศึกษา"]
        ,["endyear","ปีจบการศึกษา(พ.ศ)"]
        ,["qcode","รหัสวุฒิการศึกษา"]
        ,["ecode","รหัสระดับการศึกษา"]
        ,["macode","รหัสสาขา/วิชาเอก"]
        ,["institute","สถาบัน"]
        ,["cocode","รหัสประเทศ"]
];
        ...
        ,listeners: {
                ...
                ,afteredit: function(obj){
                   if (obj.column == 4){
                            ...
                            if ( data_field_tmp == 'endyear' || data_field_tmp == 'institute' ){
                                     ...
                                     obj.record.data.code = "";
                                     obj.record.commit();
                                     Ext.Msg.alert("สถานะ","สามารถพิมพ์ข้อมูลได้เฉพาะ ปีจบการศึกษา(พ.ศ),สถาบัน");
                            }
                   }      
                }
        }
...
var data_querydetailGridStore = new Ext.data.JsonStore({
        url: pre_url + "/query_all/education"
        ,root: "records"
        ,autoLoad: false
        ,totalProperty: 'totalCount'
    ...
    ,tbar: [
        ...
        ,{
                ...
                ,handler: function(){
                        ...
                        form.setAttribute("action" , pre_url + "/query_all/reporteducation?format=xls");
                ...
                ,handler: function(){
                        ...
                        var form = document.createElement("form");
                        form.setAttribute("method", "post");
                        form.setAttribute("action" , pre_url + "/query_all/reporteducation?format=pdf");
                        form.setAttribute("target", "_blank");
                        var hiddenField = document.createElement("input");
                        hiddenField.setAttribute("name", "col");
                        hiddenField.setAttribute("value", select_col_querydetail);
...
var panelMainSearch  = new Ext.Panel({
        title: "สอบถามข้อมูลประวัติการรศึกษา"
        ,layout:  "border"
        ,items: [
                data_queryGrid
