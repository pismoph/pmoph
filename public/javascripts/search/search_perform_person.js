...
var value_query_trigger = new Ext.form.TriggerField({
        ...
        ,onTriggerClick: function(){
                ...
                switch(data_queryGrid.nowRecordEdit.data.field){
                        case "j18code":
                                QueryJ18Status(data_queryGrid.nowRecordEdit);
                                break;
                        case "birthdate":
...
var data_field_query_trigger  = [
        ['j18code','รหัสปฏิบัติงานจริง']
        ,['birthdate','วัน/เดือน/ปี เกิด']
        ,['day_of_birth','วันเกิด']
        ,['month_of_birth','เดือนเกิด']
        ,['year_of_birth','ปีเกิด(พ.ศ)']
        ,['age','อายุ']
        ...
        ,listeners: {
                ...
                ,afteredit: function(obj){
                   if (obj.column == 4){
                            ...
                            if ( data_field_tmp == 'day_of_birth' || data_field_tmp == 'month_of_birth' || data_field_tmp == 'year_of_birth' || data_field_tmp == 'age'){
                                     ...
                                     obj.record.data.code = "";
                                     obj.record.commit();
                                     Ext.Msg.alert("สถานะ","สามารถพิมพ์ข้อมูลได้เฉพาะ วันเกิด,เดือนเกิด,ปีเกิด,อายุ");
                            }
                   }      
                }
        }
        ...
        ,{
                ...
                ,handler: function(){
				   ...
				   ,'กระทรวงปฎิบัติจริง','กองปฎิบัติจริง','กรมปฎิบัติจริง','หน่วยงานปฎิบัติจริง','ฝ่าย/กลุ่มงานปฎิบัติจริง','งานปฎิบัติจริง'];
                        ...
                        form.setAttribute("action" , pre_url + "/query_all/reportperform?format=xls");
                ...
                ,handler: function(){
				   ...
				   ,'กระทรวงปฎิบัติจริง','กองปฎิบัติจริง','กรมปฎิบัติจริง','หน่วยงานปฎิบัติจริง','ฝ่าย/กลุ่มงานปฎิบัติจริง','งานปฎิบัติจริง'];
                        ...
                        var form = document.createElement("form");
                        form.setAttribute("method", "post");
                        form.setAttribute("action" , pre_url + "/query_all/reportperform?format=pdf");
                        form.setAttribute("target", "_blank");
                        var hiddenField = document.createElement("input");
                        hiddenField.setAttribute("name", "col");
                        hiddenField.setAttribute("value", select_col_querydetail);
