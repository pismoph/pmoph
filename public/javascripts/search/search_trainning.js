...
col_prepare = ["codetrade","recode","provcode","mrcode","sex","begindate","enddate","cource","institute","cocode"];
var data_field_query_trigger  = [
    ["codetrade","รหัสใบประกอบวิชาชีพ"]
    ,["recode","รหัสศาสนา"]
    ,["provcode","รหัสภูมลำเนา"]
        ...
        ,listeners: {
                ...
                ,afteredit: function(obj){
                   if (obj.column == 4){
                            ...
                            if ( data_field_tmp == 'cource' || data_field_tmp == 'institute' ){
                                     ...
                                     obj.record.data.code = "";
                                     obj.record.commit();
                                     Ext.Msg.alert("สถานะ","สามารถพิมพ์ข้อมูลได้เฉพาะ หลักสูตร,สถาบัน");
                            }
                   }      
                }
        }
...
var data_querydetailGridStore = new Ext.data.JsonStore({
        url: pre_url + "/query_all/trainning"
        ,root: "records"
        ,autoLoad: false
        ,totalProperty: 'totalCount'
    ...
    ,tbar: [
        ...
        ,{
                ...
                ,handler: function(){
                        ...
                        form.setAttribute("action" , pre_url + "/query_all/reporttrainning?format=xls");
                ...
                ,handler: function(){
                        ...
                        var form = document.createElement("form");
                        form.setAttribute("method", "post");
                        form.setAttribute("action" , pre_url + "/query_all/reporttrainning?format=pdf");
                        form.setAttribute("target", "_blank");
                        var hiddenField = document.createElement("input");
                        hiddenField.setAttribute("name", "col");
                        hiddenField.setAttribute("value", select_col_querydetail);
...
var panelMainSearch  = new Ext.Panel({
        title: "สอบถามข้อมูลการประชุม/อบรม/สัมมนา"
        ,layout:  "border"
        ,items: [
                data_queryGrid
