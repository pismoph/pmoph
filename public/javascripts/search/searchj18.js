         ...
         ,onTriggerClick: function(){
                  ...
                  switch(data_queryGrid.nowRecordEdit.data.field){
                           ...
                           case "lname":
                                    ...
                                    break;
                           case "work_place":
                                    QueryWorkPlacename(data_queryGrid.nowRecordEdit);
                                    break;
                           case "poscode":
                                    QueryPosname(data_queryGrid.nowRecordEdit);
                                    break;
                           case "excode":
                                    QueryExname(data_queryGrid.nowRecordEdit);
                                    break;
                           case "epcode":
                                    QueryExpert(data_queryGrid.nowRecordEdit);
                                    break;
                           case "ptcode":
                                    QueryPtname(data_queryGrid.nowRecordEdit);
                                    break;
                           case "salary":
...
var data_field_query_trigger  = [
        ['fname','ชื่อ']
        ,['lname','นามสกุล']
        ,['work_place', 'รหัสหน่วยงานตาม จ.18']			
        ,['poscode','รหัสตำแหน่งสายงานตาม จ.18']
        ,['excode','รหัสตำแหน่งบริหารตาม จ.18']
        ,['epcode','รหัสความเชี่ยวชาญตาม จ.18']
        ,['ptcode','รหัสว./วช./ชช. ตาม จ.18']  
        ...
        ,bbar: [
                        ...
                        ,{
                                ...
                                ,handler: function(){
                                                ...
                                                for (i=0;i<tmp_case.length ;i++ ){
                                                        ...
                                                        if (tmp_case[i].data["field"] == "work_place"){
                                                               if (tmp_case[i].data["operator"] != "="){
                                                                        Ext.Msg.alert("สถานะ","กรุณาเลือก Operator ในบรรทัด รหัสหน่วยงาน เป็น \"เท่ากับ\"");
                                                                        return false;
                                                               }
                                                        }
                                                }
                                        ...
                                        col_prepare = ['fname','lname','minname','division','deptname','subdeptname','secname','jobname','posname','exname','expert','ptname','salary'];
                                        col_dis = ['ชื่อ','นามสกุล','กระทรวงตาม จ.18','กองตาม จ.18','กรมตาม จ.18','หน่วยงานตาม จ.18','ฝ่าย/กลุ่มงานตาม จ.18','งานตาม จ.18','ตำแหน่งสายงานตาม จ.18','ตำแหน่งบริหารตาม จ.18','ตำแหน่งวิชาการตาม จ.18','ว./วช./ชช.ตาม จ.18','เงินเดือนตาม จ.18'];
        ...
        ,listeners: {
                ...
                ,afteredit: function(obj){
                   if (obj.column == 4){
                            ...
                            if ( data_field_tmp == "fname" || data_field_tmp == "lname" || data_field_tmp == "salary"){
                                     ...
                                     obj.record.data.code = "";
                                     obj.record.commit();
                                     Ext.Msg.alert("สถานะ","สามารถพิมพ์ข้อมูลได้เฉพาะ ชื่อ,นามสกุล,เงินเดือน");
                            }
                   }      
                }
        }
    ...
    ,tbar: [
        ...
        ,{
                ...
                ,handler: function(){
                        ...
                        form.setAttribute("action" , pre_url + "/query_all/reportj18?format=xls");
                ...
                ,handler: function(){
                        ...
                        var form = document.createElement("form");
                        form.setAttribute("method", "post");
                        form.setAttribute("action" , pre_url + "/query_all/reportj18?format=pdf");
                        form.setAttribute("target", "_blank");
                        var hiddenField = document.createElement("input");
                        hiddenField.setAttribute("name", "col");
                        hiddenField.setAttribute("value", select_col_querydetail);
