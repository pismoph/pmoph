...
var value_query_trigger = new Ext.form.TriggerField({
        ...
        ,onTriggerClick: function(){
                ...
                switch(data_queryGrid.nowRecordEdit.data.field){
                            case "force_day":
                                     QueryInt(data_queryGrid.nowRecordEdit);
                                     break;
                            case "force_month":
                                     QueryInt(data_queryGrid.nowRecordEdit);
                                     break;
                            ...
                            case "force_duration":
                                     ...
                                     break;
                            case "updcode":
                                     QueryUpdate(data_queryGrid.nowRecordEdit);
                                     break;
                            case "work_place":
                                     QueryWorkPlacenameNotSet(data_queryGrid.nowRecordEdit);
                                     break;
                }			
        }
});
...
var data_field_query_trigger  = [
        ['force_day','วันของมีผลบังคับใช้']
        ,['force_month','เดือนที่มีผลบังคับใช้']
        ,['force_year','ปีที่มีผลบังคับใช้(พ.ศ)']
        //,['force_duration','ระยะเวลาที่มีผลบังคับใช้(ปี)']
        ,['updcode','รหัสการเคลื่อนไหว']
        ,['work_place','รหัสหน่วยงานตามประวัติ']
];
        ...
        ,bbar: [
                        ...
                        ,{
                                ...
                                ,handler: function(){
                                        ...
                                        col_dis = ['ชื่อ','นามสกุล','กระทรวงตามประวัติ','กองตามประวัติ','กรมตามประวัติ','หน่วยงานตามประวัติ','ฝ่าย/กลุ่มงานตามประวัติ','งานตามประวัติ','ตำแหน่งสายงานตามประวัติ','ตำแหน่งบริหารตามประวัติ','ตำแหน่งวิชาการตามประวัติ','ว./วช./ชช. ตามประวัติ','เงินเดือนตามประวัติ','ตำแหน่งเลขที่ตามประวัติ','วันที่บรรจุ','วันเกิด','วันที่เกษียณ','อายุ','อายุราชการ'];
        ...
        ,listeners: {
                ...
                ,afteredit: function(obj){
                   if (obj.column == 4){
                            ...
                            if ( data_field_tmp == "force_day" || data_field_tmp == "force_month" || data_field_tmp == "force_year" || data_field_tmp == "force_duration"){
                                     ...
                                     obj.record.data.code = "";
                                     obj.record.commit();
                                     Ext.Msg.alert("สถานะ","สามารถพิมพ์ข้อมูลได้เฉพาะ วันที่มีผลบังคับใช้,เดือนที่มีผลบังคับใช้,ปีที่มีผลบังคับใช้,ระยะเวลาที่มีผลบังคับใช้(ปี)");
                            }
                   }      
                }
        }
    ...
    ,tbar: [
        ...
        ,{
                ...
                ,handler: function(){
                        ...
                        form.setAttribute("action" , pre_url + "/query_all/reportposhist?format=xls");
                ...
                ,handler: function(){
                        ...
                        var form = document.createElement("form");
                        form.setAttribute("method", "post");
                        form.setAttribute("action" , pre_url + "/query_all/reportposhist?format=pdf");
                        form.setAttribute("target", "_blank");
                        var hiddenField = document.createElement("input");
                        hiddenField.setAttribute("name", "col");
                        hiddenField.setAttribute("value", select_col_querydetail);
...
var panelMainSearch  = new Ext.Panel({
        title: "สอบถามข้อมูลประวัติการดำรงตำแหน่ง"
        ,layout:  "border"
        ,items: [
                data_queryGrid
...
function QueryDetailPosHist(){
       ...
       col_compare = {
          fname:'ชื่อ'
          ,lname:'นามสกุล'
          ,minname: 'กระทรวงตามประวัติ'
          ,division: 'กองตามประวัติ'
          ,deptname: 'กรมตามประวัติ'				
          ,subdeptname: 'หน่วยงานตามประวัติ'
          ,secname: 'ฝ่าย/กลุ่มงานตามประวัติ'
          ,jobname: 'งานตามประวัติ'				
          ,posname: 'ตำแหน่งสายงานตามประวัติ'
          ,exname: 'ตำแหน่งบริหารตามประวัติ'
          ,expert: 'ตำแหน่งวิชาการตามประวัติ'
          ,ptname: 'ว/วช/ชช ตามประวัติ'  
          ,salary: 'เงินเดือนตามประวัติ'
          ,posid: 'ตำแหน่งเลขที่ตามประวัติ'
