...
var data_field_query_trigger  = [
        ['qcode','รหัสวุฒิการศึกษาในตำแหน่ง']
        ,['macode','รหัสสาขา/เอกวิชา']
        ,['codetrade','รหัสใบประกอบวิชาชีพ']
        ,['recode','รหัสศาสนา']
        ,['mrcode','รหัสสถานภาพสมรส']
        ,['sex','เพศ']
        ,['recdate','วันที่รับเหรียญ']
        ,['kitjadate','ประกาศในราชกิจจานุเบกษาวันที่']
        ,['retdate','วันที่คืนเหรียญ']
        ,['work_place','รหัสหน่วยงานตามจ.18']
];
        ...
        ,listeners: {
                ...
                ,afteredit: function(obj){
                   if (obj.column == 4){
                            ...
                            obj.record.data.code = "";
                            obj.record.commit();
                            Ext.Msg.alert("สถานะ","ไม่สามารถพิมพ์ข้อมูลได้");
                   }      
                }
        }
});
    ...
    ,tbar: [
        ...
        ,{
                ...
                ,handler: function(){
                        ...
                        form.setAttribute("action" , pre_url + "/query_all/reportinsig?format=xls");
                ...
                ,handler: function(){
                        ...
                        var form = document.createElement("form");
                        form.setAttribute("method", "post");
                        form.setAttribute("action" , pre_url + "/query_all/reportinsig?format=pdf");
                        form.setAttribute("target", "_blank");
                        var hiddenField = document.createElement("input");
                        hiddenField.setAttribute("name", "col");
                        hiddenField.setAttribute("value", select_col_querydetail);
...
var panelMainSearch  = new Ext.Panel({
        title: "สอบถามข้อมูลประวัติการรับพระราชทานเครื่องราชอิสริยาภรณ์"
        ,layout:  "border"
        ,items: [
                data_queryGrid
