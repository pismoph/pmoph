...
var checkbox1 = new Ext.form.Checkbox({
	id: 'checkbox1',
	boxLabel: 'ตัดโอนตำแหน่งและอัตราเงินเดือน'
});
...
var frmAddEdit = new Ext.form.FormPanel({
	id: 'frmAddEdit',
	title: 'บันทึกคำสั่งย้ายออกนอกหน่วยงาน / ลาออก / เกษียณอายุ / ตาย',
	labelAlign: 'left',
	labelWidth: 100,
	autoScroll: true,
	frame: true,
...
var GridStorePosition = new Ext.data.JsonStore({
	url: pre_url+'/cmd5/list_position',
	root: 'Records',
...
function save_data(){
	Ext.Ajax.request({
		...
		params: {
			...
			chk: checkbox1.getValue(), //ตัดโอนตำแหน่งและอัตราเงินเดือน จะคืนค่า true กับ false
