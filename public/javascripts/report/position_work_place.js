work_place = {
         ...
         ,sdcode_show: "position_work_place_subdept_show"
         ,sdcode_button: "position_work_place_subdept_button"
                                        ...
                                        ,items: [
                                            {
                                                ...
                                                ,listeners: {
                                                    keydown : function( el,e ){
                                                        Ext.getCmp("position_work_place_subdept_show").setValue("");
                                                            ...
                                                            Ext.Ajax.request({
                                                               ...
                                                               ,success: function(response,opts){
                                                                  ...
                                                                  if (obj.totalcount == 0){
                                                                     ...
                                                                     Ext.getCmp("position_work_place_subdept_show").setValue(obj.records[0].subdeptname);
                                                                  }
                                                    ...
                                                    ,blur: function(el){
                                                             if (Ext.getCmp("position_work_place_subdept_show").getValue() == ""){
                                                                      Ext.getCmp("work_place[sdcode]").setValue("");
                                                                      Ext.getCmp("position_work_place_subdept_show").setValue("");    
                                                             }
                                                    }
                                            ...
                                            ,{
                                                xtype: "textfield"
                                                ,id: "position_work_place_subdept_show"
                                                ,readOnly: true
                                                ,style: "color: #ffffff;background-color:#888888;background-image:url('#');width:75%;"
                                            }
                                            ,{
                                                xtype: "button"
                                                ,id: "position_work_place_subdept_button"
                                                ,text: "..."
                                                ,handler: function(){
                                                         searchSubdept(Ext.getCmp("work_place[sdcode]"),Ext.getCmp("position_work_place_subdept_show"));
                                                }
                                            }
                                        ]
                                    }
...
var reportCols = [
    ...
    ,{header: "ชื่อหน่วยงาน",width: 350, sortable: false, dataIndex: 'subdeptname'}
...
var reportGridStore = new Ext.data.JsonStore({
         url: pre_url + "/report/position_work_place"
         ,root: "records"
         ,autoLoad: false
         ...
         ,tbar:[
            {
                ...
                ,handler: function(){
                    ...
                    form.setAttribute("action" , pre_url + "/report/report_position_work_place?format=xls");
                ...
                ,handler: function(){
                    ...
                    var form = document.createElement("form");
                    form.setAttribute("method", "post");
                    form.setAttribute("action" , pre_url + "/report/report_position_work_place?format=pdf");
                    form.setAttribute("target", "_blank");
                    var field2 = document.createElement("input");
                    field2.setAttribute("name", "jobcode");
                    field2.setAttribute("value", Ext.getCmp("work_place[jobcode]").getValue() );
...
var panelReport = new Ext.Panel({
    title: "จำนวนตำแหน่งสายงานข้าราชการจำแนกตามหน่วยงาน(จ.18)"
    ,layout: "border"
    ,items: [
        panleSearch
        ,reportGrid
