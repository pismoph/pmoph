         ...
         ,tbar:[
            {
                ...
                ,handler: function(){
                    ...
                    form.setAttribute("action" , pre_url + "/report/report_work_place?format=xls");
                ...
                ,handler: function(){
                    ...
                    var form = document.createElement("form");
                    form.setAttribute("method", "post");
                    form.setAttribute("action" , pre_url + "/report/report_work_place?format=pdf");
                    form.setAttribute("target", "_blank");
                    var field2 = document.createElement("input");
                    field2.setAttribute("name", "jobcode");
                    field2.setAttribute("value", Ext.getCmp("work_place[jobcode]").getValue() );
...
var panelReport = new Ext.Panel({
    title: "ข้าราชการจำแนกตามหน่วยงาน"
    ,layout: "border"
    ,items: [
        panleSearch
        ,reportGrid
